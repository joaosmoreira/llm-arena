...
const serverEnvSchema = z.object({
  ...
  DATABASE_URL: z.string().min(1, "DATABASE_URL is required").optional().default("postgresql://localhost:5432/llm_arena"),
...
export const env = {
  get OPENROUTER_API_KEY(): string {
    ...
    if (!key) {
      throw new Error("Missing OPENROUTER_API_KEY environment variable. Please set it in your .env.local file.");
    }
    return key;
  },
